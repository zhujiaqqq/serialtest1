...
//        }
        ...
        list.add(new ModuleBean("语音报文发送", R.drawable.ic_keyboard_voice_black_24dp, Yybwfs_Activity.class, null));
        list.add(new ModuleBean("北斗模块信息", R.drawable.ic_keyboard_voice_black_24dp, Bdxx_Activity.class, null));
        list.add(new ModuleBean("语音收发记录", R.drawable.ic_keyboard_voice_black_24dp, Yysfjl_Activity.class, null));
        list.add(new ModuleBean("系统状态信息", R.drawable.ic_keyboard_voice_black_24dp, Xtxx_Activity.class, null));
