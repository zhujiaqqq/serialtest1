...
public class Yysfjl_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //save_data[14] = "收发       对方号码    语音内容";
        ...
        adapter = new ArrayAdapter<String>(Yysfjl_Activity.this,android.R.layout.simple_expandable_list_item_1, save_data);
