...
public class Bdxx_Activity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(Bdxx_Activity.this);
    ...
    public void onEvent(Event_FKXX event){
        AlertDialog.Builder dialog = new AlertDialog.Builder(Bdxx_Activity.this);
        dialog.setTitle("    ");
